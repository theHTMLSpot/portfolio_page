...
export default function ProjectListing({ project }: { project: project }) {
  return (
    <Container className="m-0 flex w-full flex-col items-start justify-center border-gray-500 rounded-xl p-10 border">
      <motion.div initial={{scale: 0.8}} animate={{scale:1}} transition={{duration: 0.5, delay: 0.1}} className="h-1/2 w-full  transition-all duration-300 ease-in-out hover:scale-102">
        <Image
          src={project.image}
          alt="Decorative Background"
          className="w-full object-cover hover:shadow-teal-600 hover:shadow-lg "
          width={1920}
          height={1080}
          priority
        />
